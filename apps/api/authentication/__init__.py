...
NIGERIAN_COUNTRIES = [
    ...
    # ==================== ASIA (48 UN members + territories) ====================
    ...
    # ==================== EUROPE (40 UN members + others) ====================
    "Albania", "Andorra", "Austria", "Belarus", "Belgium",
    "Bosnia and Herzegovina", "Bulgaria", "Croatia", "Czech Republic", "Denmark",
    "Estonia", "Finland", "France", "Germany", "Greece", "Guernsey", "Hungary",
    ...
    # ==================== NORTH AMERICA & CARIBBEAN (28 + territories) ====================
    ...
    # French territories
    "French Guiana", "Guadeloupe", "Martinique", "Saint Barthélemy", "Saint Martin",
    ...
    "Midway Atoll", "Navassa Island", "Wake Island",
    # French territories
